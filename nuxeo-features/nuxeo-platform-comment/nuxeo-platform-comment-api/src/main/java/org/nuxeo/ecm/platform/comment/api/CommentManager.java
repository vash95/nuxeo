...
public interface CommentManager {
     ...
     * @since 11.1
     */
     default DocumentRef getAncestorRef(CoreSession session, DocumentRef commentIdRef){
     ...
     *
     * @param session the core session
     * @param documentModel the document model (can be another comment in the case of reply) for which we create the comment
