...
public class TestCommentsMigrator {
    ...
    @Test
    public void testMigrationFromPropertyToSecured() {
        // Create comments as property on these files and add some replies
        // Total of comments:
    ...
    public void testMigrationThroughService() {
        ...
        // Launch the step relation to property and wait until its finishes
        ...
        // Launch the step property to secured and wait until its finishes
