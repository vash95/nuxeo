...
public class TestTreeCommentManager extends AbstractTestCommentManager {
    ...
    public void shouldGetComments() {
        ...
        // Let add a new comment and some replies
    ...
    public void shouldUpdateComment() {
        ...
        // If i am the author of the comment i can update it
        try (CloseableCoreSession jamesSession = CoreInstance.openCoreSession(doc.getRepositoryName(), "james")) {
    ...
    public void shouldDeleteComment() {
        ...
        // Just create another comment with another author
    ...
    /**
     * Verify the commons infos when create or update a comment
     */
    protected void verifyCommonsInfo(DocumentModel doc, Comment commentToCreate, Comment createdComment,
            int numberOfAncestor) {
        // For backward compatibility we should keep the whole comment properties filled as it's done in 10.10
        // to break any customer code which relies on the `Comment` schema,
